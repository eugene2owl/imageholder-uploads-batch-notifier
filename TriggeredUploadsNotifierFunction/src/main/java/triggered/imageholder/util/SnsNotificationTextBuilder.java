package triggered.imageholder.util;
...
public class SnsNotificationTextBuilder {
    ...
    public static String buildTextAboutUploadedImages(List<S3EventNotificationRecord> messages, LambdaLogger logger) {
    ...
    private static String buildTextAboutUploadedImages(S3EventNotificationRecord message, LambdaLogger logger) {
        try {
            var s3Object = message
                    .getS3()
                    .getObject();
